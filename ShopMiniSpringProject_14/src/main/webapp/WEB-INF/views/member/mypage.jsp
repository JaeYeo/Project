...
<input type="text" name="post" id="sample4_postcode" placeholder="우편번호" value="${login.post }">
...
<input type="text" name="phone2" value="${login.phone2 }">-<input type="text" name="phone3" value="${login.phone3 }">
<br>
이메일:<input type="text" name="email1" value="${login.email1 }">@
       <input type="text" name="email2" id="email2" placeholder="직접입력" value="${login.email2 }">
